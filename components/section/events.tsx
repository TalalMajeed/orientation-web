...
export default function EventsSection() {
  return (
    <section id="events" className="relative overflow-hidden bg-surface px-6 py-28 sm:px-10">
      <DecorEllipse className="orbit pointer-events-none absolute right-[-10%] top-[8%] h-[60%] w-[52%] text-fg/15" />
      <div className="relative mx-auto max-w-[1600px]">
        <p className="font-italic text-sm italic text-fg/50">— What&apos;s on</p>
        <div className="mt-4">
          <h2 className="font-serif text-[18vw] font-bold leading-[0.8] text-fg lg:text-[14vw]">
            Events
          </h2>
